...
class FormInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      autocorrect: false,
      style: TextStyle(fontFamily: CustomFonts.get.oxygen_bold, color: Colors.white, fontSize: 16),
      ...
      decoration: InputDecoration(
        ...
        labelText: labelText,
        labelStyle: TextStyle(fontFamily: CustomFonts.get.oxygen_bold, color: Colors.white, fontSize: 16),
